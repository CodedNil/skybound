...
use crate::utils::{
    AtmosphereData, blue_noise, get_sun_position, position_ndc_to_world, uv_to_ndc,
};
...
pub fn main_fs(
    ...
    atmosphere.sun = (get_sun_light_color(view, sun_dir) * 0.45 + atmosphere.sky * 0.18) * phase;
    ...
    if depth < 1_000_000.0 {
        ...
        _frag_depth = clip_curr.z / clip_curr.w;
    }
